...
CLIENT_ID = f"buses-50-1049-{uuid.uuid4().hex}"
src_client = mqtt.Client(client_id=CLIENT_ID)

# Suscripciones específicas para empresa 50 y bus 1049
TOPICS = [
    "STMBuses/50/1049/+/Vehiculo/Ocupacion/3_0",
    "STMBuses/50/1049/+/DatosOperacionales/EstadoOperativo/3_0",
    "STMBuses/50/1049/+/DatosOperacionales/Parada/3_0",
]
...
def on_message_src(client, userdata, msg):
    ...
    try:
        ...
        if len(topic_parts) >= 7 and topic_parts[0] == "STMBuses" and topic_parts[1] == "50" and topic_parts[2] == "1049":
